...
namespace SACTicketFormatter3._0
{
    public partial class Groups : Form
    {
        ...
        public Groups(string User, string userid, int groups)
        {
            InitializeComponent();
            temp = new string[groups];
            user = User;
            prim_userid = userid;
        ...
        public Groups(string[] temp, string[] temp2, string user, string prim_userid, SecureString aPassword, IContainer components, DataGridView dataGridView1, DataGridViewTextBoxColumn group, Button button1, Label label1, TextBox tbUsername, Label label2, TextBox tbAUsername, TextBox tbAPassword, Label label3, Label label4)
        {
            ...
            this.prim_userid = prim_userid ?? throw new ArgumentNullException(nameof(prim_userid));
            this.aPassword = aPassword ?? throw new ArgumentNullException(nameof(aPassword));
            ...
            this.button1 = button1 ?? throw new ArgumentNullException(nameof(button1));
            this.label1 = label1 ?? throw new ArgumentNullException(nameof(label1));
            this.tbUsername = tbUsername ?? throw new ArgumentNullException(nameof(tbUsername));
            this.label2 = label2 ?? throw new ArgumentNullException(nameof(label2));
            this.tbAUsername = tbAUsername ?? throw new ArgumentNullException(nameof(tbAUsername));
            this.tbAPassword = tbAPassword ?? throw new ArgumentNullException(nameof(tbAPassword));
        ...
        private void button1_Click_1(object sender, EventArgs e)
        {
            ...
            {
                //Exception List of Groups
                if( temp[g] == "Domain Users" ||
                    temp[g] == "Defender-DefaultClientOptions" ||
                    temp[g] == "KENO-2FA-Users" ||
                    temp[g] == "O365E1" ||
                    temp[g] == "O365E3" ||
                    temp[g] == "O365E5" ||
                    temp[g] == "O365Migrated")
